...
class LostHatTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver = webdriver.Chrome(executable_path=r"C:\Users\eszub\PycharmProjects\chromedriver.exe")
    ...
    def test_correct_login(self):
        ...
        expected_text = 'Edyta Koniak'
        user_email = 'rejestracje.w.necie@gmail.com'
        user_pass = 'haslo'
        driver = self.driver
